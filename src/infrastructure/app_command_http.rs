...
use crate::domain::ReceiverEndpoint;
use crate::protocol::app_command::{AppCommandRequest, AppCommandResponse, APP_COMMAND_0300_PATH};
...
fn parse_app_command_exchange(http: RawHttpResponse) -> io::Result<AppCommandExchange> {
    ...
    let response = crate::protocol::app_command::parse_app_command_response(&http.body)
