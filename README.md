...
The next layer is the persistent async TCP session: serialized writes, bounded reads, unsolicited event routing, reconnects, and structured transport errors.
