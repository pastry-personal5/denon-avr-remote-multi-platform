...
The GUI is not part of the current v1 release. Phase 1 first establishes the layered application architecture, Phase 2 delivers a buildable read-only Iced desktop application, Phase 6 adds validated X3800H controls, and Phase 7 stabilizes the completed application lifecycle. This guide defines the intended
...
The existing CLI remains supported. Both interfaces use the same platform-native receiver configuration after importing a valid legacy `config/denon-avr-remote.yaml` when necessary.
...
- [Phase 1 overview](v2/phase-1-overview.md) and
  [architecture](v2/phase-1-architecture.md)
- [Phase 2 overview](v2/phase-2-overview.md) and
  [architecture](v2/phase-2-architecture.md)
- [Phase 6 overview](v2/phase-6-overview.md) and
  [architecture](v2/phase-6-architecture.md)
- [Phase 7 overview](v2/phase-7-overview.md) and
  [architecture](v2/phase-7-architecture.md)
